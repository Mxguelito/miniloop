...
async function handlePublicar() {
  if (!window.confirm("¿Publicar esta liquidación? Los propietarios podrán verla.")) return;
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
  ...
  {/* INGRESOS EXPENSAS */}
  <div className="p-5 rounded-2xl bg-gradient-to-br from-green-700/30 to-green-500/20
  ...
  {/* INGRESOS EXTRA */}
  <div className="p-5 rounded-2xl bg-gradient-to-br from-blue-700/30 to-blue-500/20
  ...
  {/* GASTOS */}
  <div className="p-5 rounded-2xl bg-gradient-to-br from-red-700/30 to-red-500/20
  ...
  {/* ADEUDADO */}
  <div className="p-5 rounded-2xl bg-gradient-to-br from-yellow-700/30 to-yellow-500/20
...
>
  ...
  <div className="flex justify-between items-center mb-2">
    <h3 className="text-blue-400 font-semibold text-lg">{p.nombre || "Propietario"}</h3>
 ...
 <div className="text-gray-400 text-sm mb-2">
  ...
  <div className="grid grid-cols-2 gap-2">
    <div>
      <label className="text-gray-400 text-xs">Expensa del mes</label>
      <input
        type="number"
        placeholder="0"
        value={p.expensaMes ?? 0}
        onChange={(e) =>
          updatePropietario(p.id, "expensaMes", Number(e.target.value))
        }
    ...
    <div>
      ...
      <input
        ...
        onChange={(e) =>
          updatePropietario(p.id, "montoAbonado", Number(e.target.value))
        }
        className="bg-[#0d1117] border border-blue-500/30 rounded-lg px-2 h-8 text-sm text-white"
      />
    </div>
